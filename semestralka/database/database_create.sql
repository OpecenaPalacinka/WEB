...
CREATE TABLE IF NOT EXISTS `OBJEDNAVKA` (
                                            ...
                                            INDEX `fk_OBJEDNAVKA_LODE1_idx` (`LODE_id_lod` ASC),
                                            ...
                                            CONSTRAINT `fk_OBJEDNAVKA_USER1`
                                                FOREIGN KEY (`USER_id_user`)
                                                    ...
                                                    ON DELETE NO ACTION
                                                    ON UPDATE NO ACTION,
                                            CONSTRAINT `fk_OBJEDNAVKA_LODE1`
...
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (2, 'Pádlo - dospělý', 50);
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (3, 'Pádlo - dítě', 30);
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (4, 'Vesta - dospělý', 75);
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (5, 'Vesta - dítě', 50);
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (6, 'Barel', 100);
INSERT INTO `PRISLUSENSTVI` (`id_prislusenstvi`, `nazev_prislusen`, `cena`) VALUES (7, 'Helma', 65);
