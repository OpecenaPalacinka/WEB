                ...
                for ($c = 0; $c < count($lode);$c++){
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-4" for="<?php echo $jmenoProLode[$c]; ?>">
                            <b><span class="cart-item-name-l"><?php echo $lode[$c]['typ_lode'];?></span> -> <span class="cart-item-price-l"><?php echo $lode[$c]['cena']." KČ";?></span></b></label>
                        <input type="button" class="btn btn-primary col-md-2 shop-add-button-l" name="<?php echo $jmenoProLode[$c]; ?>" id="<?php echo $jmenoProLode[$c]; ?>" value="Přidej">
                        <span class=""></span>
                        <label class="col-form-label col-sm-4 font-weight-bold" for="<?php echo $jmenoProPrislu[$c]; ?>">
                            <span class="cart-item-name-p"><?php echo $prislusenstvi[$c]['nazev_prislusen'];?></span> -> <span class="cart-item-price-p"><?php echo $prislusenstvi[$c]['cena']." KČ";?></span></label>
                        <input type="button" class="btn btn-primary col-md-2 shop-add-button-p" name="<?php echo $jmenoProPrislu[$c]; ?>" id="<?php echo $jmenoProPrislu[$c]; ?>" value="Přidej">
                    </div>
                <?php } ?>
